(function () {
    ...
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = e), (exports.EXIF = e)) : (this.EXIF = e);
    var i = (e.Tags = {
            36864: "ExifVersion",
    ...
    function h(i, n) {
        function o(t) {
            ...
            i.exifdata = o || {};
            var s = l(t);
            if (((i.iptcdata = s || {}), e.isXmpEnabled)) {
                var r = v(t);
                i.xmpdata = r || {};
            }
            n && n.call(i);
        ...
        if (i.src)
            if (/^data\:/i.test(i.src))
                o(
                    (function (t, e) {
                        ...
                        for (var i = atob(t), n = i.length, o = new ArrayBuffer(n), s = new Uint8Array(o), r = 0; r < n; r++) s[r] = i.charCodeAt(r);
                        return o;
                    })(i.src)
                );
            ...
            self.FileReader &&
                ...
                (((s = new FileReader()).onload = function (e) {
                    t && console.log("Got file of length " + e.target.result.byteLength), o(e.target.result);
                }),
                s.readAsArrayBuffer(i));
    }
    function u(e) {
        var i = new DataView(e);
        if ((t && console.log("Got file of length " + e.byteLength), 255 != i.getUint8(0) || 216 != i.getUint8(1))) return t && console.log("Not a valid JPEG"), !1;
        for (var n, o = 2, s = e.byteLength; o < s; ) {
            if (255 != i.getUint8(o)) return t && console.log("Not a valid marker at offset " + o + ", found: " + i.getUint8(o)), !1;
            if (((n = i.getUint8(o + 1)), t && console.log(n), 225 == n)) return t && console.log("Found 0xFFE1 marker"), g(i, o + 4, i.getUint16(o + 2));
            o += 2 + i.getUint16(o + 2);
        }
    }
    function l(e) {
        ...
        for (
            ...
            if (s(i, n)) {
                var r = i.getUint8(n + 7);
                return r % 2 != 0 && (r += 1), 0 === r && (r = 4), d(e, n + 8 + r, i.getUint16(n + 6 + r));
            }
            n++;
        }
    }
    ...
    function d(t, e, i) {
        for (var n, o, s, r, a = new DataView(t), h = {}, u = e; u < e + i; )
            28 === a.getUint8(u) &&
                2 === a.getUint8(u + 1) &&
                (r = a.getUint8(u + 2)) in c &&
                ((s = a.getInt16(u + 3)) + 5, (o = c[r]), (n = f(a, u + 5, s)), h.hasOwnProperty(o) ? (h[o] instanceof Array ? h[o].push(n) : (h[o] = [h[o], n])) : (h[o] = n)),
                u++;
        return h;
    }
    function p(e, i, n, o, s) {
        var r,
            ...
            u = e.getUint16(n, !s),
            l = {};
        for (h = 0; h < u; h++) (r = n + 12 * h + 2), !(a = o[e.getUint16(r, !s)]) && t && console.log("Unknown tag: " + e.getUint16(r, !s)), (l[a] = _(e, r, i, n, s));
        return l;
    }
    function _(t, e, i, n, o) {
        var s,
            ...
            c = t.getUint16(e + 2, !o),
            d = t.getUint32(e + 4, !o),
            p = t.getUint32(e + 8, !o) + i;
        switch (c) {
            case 1:
            case 7:
                if (1 == d) return t.getUint8(e + 8, !o);
                for (s = d > 4 ? p : e + 8, r = [], h = 0; h < d; h++) r[h] = t.getUint8(s + h);
                return r;
            case 2:
                return f(t, (s = d > 4 ? p : e + 8), d - 1);
            case 3:
                if (1 == d) return t.getUint16(e + 8, !o);
                for (s = d > 2 ? p : e + 8, r = [], h = 0; h < d; h++) r[h] = t.getUint16(s + 2 * h, !o);
                return r;
            case 4:
                if (1 == d) return t.getUint32(e + 8, !o);
                for (r = [], h = 0; h < d; h++) r[h] = t.getUint32(p + 4 * h, !o);
                return r;
            case 5:
                if (1 == d) return (u = t.getUint32(p, !o)), (l = t.getUint32(p + 4, !o)), ((a = new Number(u / l)).numerator = u), (a.denominator = l), a;
                for (r = [], h = 0; h < d; h++) (u = t.getUint32(p + 8 * h, !o)), (l = t.getUint32(p + 4 + 8 * h, !o)), (r[h] = new Number(u / l)), (r[h].numerator = u), (r[h].denominator = l);
                return r;
            case 9:
                if (1 == d) return t.getInt32(e + 8, !o);
                for (r = [], h = 0; h < d; h++) r[h] = t.getInt32(p + 4 * h, !o);
                return r;
            case 10:
                if (1 == d) return t.getInt32(p, !o) / t.getInt32(p + 4, !o);
                for (r = [], h = 0; h < d; h++) r[h] = t.getInt32(p + 8 * h, !o) / t.getInt32(p + 4 + 8 * h, !o);
                return r;
        }
    }
    function m(t, e, i, n) {
        var o = (function (t, e, i) {
            var n = t.getUint16(e, !i);
            return t.getUint32(e + 2 + 12 * n, !i);
        })(t, e + i, n);
        if (!o) return {};
                ...
                case 6:
                    if (r.JpegIFOffset && r.JpegIFByteCount) {
                        var a = e + r.JpegIFOffset,
                            h = r.JpegIFByteCount;
                        r.blob = new Blob([new Uint8Array(t.buffer, a, h)], { type: "image/jpeg" });
                    }
                    break;
                case 1:
    ...
    function f(t, e, i) {
        for (var n = "", o = e; o < e + i; o++) n += String.fromCharCode(t.getUint8(o));
        return n;
    }
    function g(e, s) {
        if ("Exif" != f(e, s, 4)) return t && console.log("Not valid EXIF data! " + f(e, s, 4)), !1;
        var a,
            h,
            u,
            l,
            c,
            d = s + 6;
        if (18761 == e.getUint16(d)) a = !1;
        else {
            if (19789 != e.getUint16(d)) return t && console.log("Not valid TIFF data! (no 0x4949 or 0x4D4D)"), !1;
            a = !0;
        }
        if (42 != e.getUint16(d + 2, !a)) return t && console.log("Not valid TIFF data! (no 0x002A)"), !1;
        var _ = e.getUint32(d + 4, !a);
        if (_ < 8) return t && console.log("Not valid TIFF data! (First offset less than 8)", e.getUint32(d + 4, !a)), !1;
        if ((h = p(e, d, d + _, n, a)).ExifIFDPointer)
            for (u in (l = p(e, d, d + h.ExifIFDPointer, i, a))) {
                switch (u) {
                    case "LightSource":
                    case "Flash":
                    case "MeteringMode":
                    ...
                    case "ComponentsConfiguration":
                        l[u] = r.Components[l[u][0]] + r.Components[l[u][1]] + r.Components[l[u][2]] + r.Components[l[u][3]];
                }
                h[u] = l[u];
            }
        if (h.GPSInfoIFDPointer)
            for (u in (c = p(e, d, d + h.GPSInfoIFDPointer, o, a))) {
                switch (u) {
                    case "GPSVersionID":
        ...
        return (h.thumbnail = m(e, d, _, a)), h;
    }
    function v(e) {
        if ("DOMParser" in self) {
            var i = new DataView(e);
            if ((t && console.log("Got file of length " + e.byteLength), 255 != i.getUint8(0) || 216 != i.getUint8(1))) return t && console.log("Not a valid JPEG"), !1;
            for (var n = 2, o = e.byteLength, s = new DOMParser(); n < o - 4; ) {
                if ("http" == f(i, n, 4)) {
                    var r = n - 1,
                        a = i.getUint16(n - 2) - 1,
                        h = f(i, r, a),
                        u = h.indexOf("xmpmeta>") + 8,
                        l = (h = h.substring(h.indexOf("<x:xmpmeta"), u)).indexOf("x:xmpmeta") + 10;
                    return (
                        (h =
                            h.slice(0, l) +
                            ...
                            h.slice(l)),
                        x(s.parseFromString(h, "text/xml"))
                    );
                }
                n++;
            }
    ...
    (e.enableXmp = function () {
        e.isXmpEnabled = !0;
    }),
        (e.disableXmp = function () {
            e.isXmpEnabled = !1;
        }),
        (e.getData = function (t, e) {
            return !(((self.Image && t instanceof self.Image) || (self.HTMLImageElement && t instanceof self.HTMLImageElement)) && !t.complete) && (a(t) ? e && e.call(t) : h(t, e), !0);
        }),
        (e.getTag = function (t, e) {
            if (a(t)) return t.exifdata[e];
        }),
        (e.getIptcTag = function (t, e) {
            if (a(t)) return t.iptcdata[e];
        }),
        (e.getAllTags = function (t) {
            if (!a(t)) return {};
            var e,
                i = t.exifdata,
                n = {};
        ...
        (e.pretty = function (t) {
            ...
            for (e in i)
                i.hasOwnProperty(e) &&
                    ("object" == typeof i[e]
                        ? i[e] instanceof Number
                            ? (n += e + " : " + i[e] + " [" + i[e].numerator + "/" + i[e].denominator + "]\r\n")
                            : (n += e + " : [" + i[e].length + " values]\r\n")
                        : (n += e + " : " + i[e] + "\r\n"));
            return n;
        }),
        (e.readFromBinaryFile = function (t) {
            return u(t);
        }),
    ...
    (function (t, e) {
        ...
        function l(t, e) {
            for (var i in (t.hasOwnProperty("options") || (t.options = t.options ? Vt(t.options) : {}), e)) t.options[i] = e[i];
            return t.options;
        }
        function c(t, e, i) {
            var n = [];
        ...
        function d(t, e) {
            return t.replace(Kt, function (t, i) {
                var n = e[i];
        ...
        function f(t, e, n) {
            if (!n || Qt !== m) return Qt.call(window, i(t, e));
            t.call(e);
        }
        function g(t) {
            t && $t.call(window, t);
        ...
        function x(t, e, i) {
            return t instanceof y ? t : Jt(t) ? new y(t[0], t[1]) : null == t ? t : "object" == typeof t && "x" in t && "y" in t ? new y(t.x, t.y) : new y(t, e, i);
        }
        function w(t, e) {
        ...
        function C(t, e, i, n) {
            if (Jt(t)) return (this._a = t[0]), (this._b = t[1]), (this._c = t[2]), void (this._d = t[3]);
        ...
        function I(t, e, i, n) {
            return (
                "touchstart" === e
                    ...
                    ? (function (t, e, i) {
                          var n = function (t) {
                              ((t.pointerType !== t.MSPOINTER_TYPE_MOUSE && "mouse" !== t.pointerType) || 0 !== t.buttons) && D(t, e);
                          };
                          (t["_leaflet_touchmove" + i] = n), t.addEventListener(Ve, n, !1);
                      })(t, i, n)
                    : "touchend" === e &&
                      (function (t, e, i) {
                          var n = function (t) {
                          ...
                          (t["_leaflet_touchend" + i] = n), t.addEventListener(qe, n, !1), t.addEventListener(Ke, n, !1);
                      })(t, i, n),
                this
            );
        }
        function Z(t, e, n) {
            var o = i(function (t) {
                if ("mouse" !== t.pointerType && t.MSPOINTER_TYPE_MOUSE && t.pointerType !== t.MSPOINTER_TYPE_MOUSE) {
                    if (!(Je.indexOf(t.target.tagName) < 0)) return;
                    gt(t);
                }
                D(t, e);
            });
            (t["_leaflet_touchstart" + n] = o),
                t.addEventListener(We, o, !1),
                Ye ||
                    (document.documentElement.addEventListener(We, B, !0),
                    document.documentElement.addEventListener(Ve, O, !0),
                    document.documentElement.addEventListener(qe, R, !0),
                    document.documentElement.addEventListener(Ke, R, !0),
                    (Ye = !0));
        }
        function B(t) {
            (Xe[t.pointerId] = t), Qe++;
        ...
        function R(t) {
            delete Xe[t.pointerId], Qe--;
        }
        function D(t, e) {
            for (var i in ((t.touches = []), Xe)) t.touches.push(Xe[i]);
        ...
        function N(t, e, i) {
            ...
            var s,
                ...
                a = !1,
                h = 250;
            return (t[ei + $e + i] = n), (t[ei + ti + i] = o), (t[ei + "dblclick" + i] = e), t.addEventListener($e, n, !1), t.addEventListener(ti, o, !1), t.addEventListener("dblclick", e, !1), this;
        }
        function F(t, e) {
            var i = t[ei + $e + e],
                n = t[ei + ti + e],
                o = t[ei + "dblclick" + e];
            return t.removeEventListener($e, i, !1), t.removeEventListener(ti, n, !1), me || t.removeEventListener("dblclick", o, !1), this;
        }
        function j(t) {
        ...
        function J(t, e) {
            if (void 0 !== t.classList) for (var i = u(e), n = 0, o = i.length; n < o; n++) t.classList.add(i[n]);
            else if (!K(t, e)) {
                var s = Q(t);
                Y(t, (s ? s + " " : "") + e);
            }
        ...
        function X(t, e) {
            void 0 !== t.classList ? t.classList.remove(e) : Y(t, h((" " + Q(t) + " ").replace(" " + e + " ", " ")));
        }
        function Y(t, e) {
        ...
        function et(t, e, i) {
            var n = e || new y(0, 0);
            t.style[ii] = (Ce ? "translate(" + n.x + "px," + n.y + "px)" : "translate3d(" + n.x + "px," + n.y + "px,0)") + (i ? " scale(" + i + ")" : "");
        }
        function it(t, e) {
            (t._leaflet_pos = e), Ae ? et(t, e) : ((t.style.left = e.x + "px"), (t.style.top = e.y + "px"));
        }
        function nt(t) {
        ...
        function rt(t) {
            ...
            t.style && (at(), (ri = t), (ai = t.style.outline), (t.style.outline = "none"), lt(window, "keydown", at));
        }
        function at() {
            ri && ((ri.style.outline = ai), (ri = void 0), (ai = void 0), ct(window, "keydown", at));
        }
        function ht(t) {
            do {
                t = t.parentNode;
        ...
        function lt(t, e, i, n) {
            if ("object" == typeof e) for (var o in e) dt(t, o, e[o], i);
            else for (var s = 0, r = (e = u(e)).length; s < r; s++) dt(t, e[s], i, n);
            return this;
        }
        function ct(t, e, i, n) {
            if ("object" == typeof e) for (var o in e) pt(t, o, e[o], i);
            else if (e) for (var s = 0, r = (e = u(e)).length; s < r; s++) pt(t, e[s], i, n);
            else {
                for (var a in t[li]) pt(t, a, t[li][a]);
                delete t[li];
            }
            return this;
        }
        function dt(t, e, i, o) {
            var s = e + n(i) + (o ? "_" + n(o) : "");
            if (t[li] && t[li][s]) return this;
            var r = function (e) {
                    return i.call(o || t, e || window.event);
                },
                a = r;
            Oe && 0 === e.indexOf("touch")
                ? I(t, e, r, s)
                : !Re || "dblclick" !== e || !N || (Oe && be)
                ? "addEventListener" in t
                    ? "mousewheel" === e
                        ? t.addEventListener("onwheel" in t ? "wheel" : "mousewheel", r, !1)
                        : "mouseenter" === e || "mouseleave" === e
                        ? ((r = function (e) {
                              (e = e || window.event), Pt(t, e) && a(e);
                          }),
                              ...
                              (r = function (t) {
                                  !(function (t, e) {
                                      var i = t.timeStamp || (t.originalEvent && t.originalEvent.timeStamp),
                                          n = hi && i - hi;
                                      (n && n > 100 && n < 500) || (t.target._simulatedClick && !t._simulated) ? vt(t) : ((hi = i), e(t));
                                  })(t, a);
                              }),
        ...
        function pt(t, e, i, o) {
            ...
            Oe && 0 === e.indexOf("touch")
                ? (function (t, e, i) {
                      ...
                      "touchstart" === e ? t.removeEventListener(We, n, !1) : "touchmove" === e ? t.removeEventListener(Ve, n, !1) : "touchend" === e && (t.removeEventListener(qe, n, !1), t.removeEventListener(Ke, n, !1));
                  })(t, e, s)
                : !Re || "dblclick" !== e || !F || (Oe && be)
        ...
        function _t(t) {
            return t.stopPropagation ? t.stopPropagation() : t.originalEvent ? (t.originalEvent._stopped = !0) : (t.cancelBubble = !0), bt(t), this;
        }
        function mt(t) {
            return dt(t, "mousewheel", _t), this;
        }
        function ft(t) {
            return lt(t, "mousedown touchstart dblclick", _t), dt(t, "click", wt), this;
        }
        function gt(t) {
            return t.preventDefault ? t.preventDefault() : (t.returnValue = !1), this;
        }
        function vt(t) {
            return gt(t), _t(t), this;
        }
        function yt(t, e) {
            if (!e) return new y(t.clientX, t.clientY);
            var i = ut(e),
                n = i.boundingClientRect;
            return new y((t.clientX - n.left) / i.x - e.clientLeft, (t.clientY - n.top) / i.y - e.clientTop);
        }
        function xt(t) {
            return me
                ? t.wheelDeltaY / 2
        ...
        function Lt(t, e) {
            ...
            return (function (t, e) {
                ...
                (n[0] = n[i - 1] = 1),
                    (function t(e, i, n, o, s) {
                        var r,
                            ...
                            h,
                            u = 0;
                        for (a = o + 1; a <= s - 1; a++) (h = Et(e[a], e[o], e[s], !0)) > u && ((r = a), (u = h));
                        u > n && ((i[r] = 1), t(e, i, n, o, r), t(e, i, n, r, s));
                    })(t, n, e, 0, i - 1);
                var o,
                    s = [];
                ...
                (t = (function (t, e) {
                    for (var i = [t[0]], n = 1, o = 0, s = t.length; n < s; n++) zt(t[n], t[o]) > e && (i.push(t[n]), (o = n));
        ...
        function St(t, e, i, n, o) {
            ...
            for (Pi = u; ; ) {
                if (!(h | u)) return [t, e];
                if (h & u) return !1;
                (a = Ct((r = Mt(t, e, (s = h || u), i, o)), i)), s === h ? ((t = r), (h = a)) : ((e = r), (u = a));
            }
        }
        ...
        function Et(t, e, i, n) {
            var o,
                ...
                h = i.y - r,
                u = a * a + h * h;
            return u > 0 && ((o = ((t.x - s) * a + (t.y - r) * h) / u) > 1 ? ((s = i.x), (r = i.y)) : o > 0 && ((s += a * o), (r += h * o))), (a = t.x - s), (h = t.y - r), n ? a * a + h * h : new y(s, r);
        }
        function At(t) {
            return !Jt(t[0]) || ("object" != typeof t[0][0] && void 0 !== t[0][0]);
        }
        function kt(t) {
            return console.warn("Deprecated use of _flat, please use L.LineUtil.isFlat instead."), At(t);
        }
        function It(t, e, i) {
            var n,
                o,
                ...
                c,
                d = [1, 4, 2, 8];
            for (o = 0, u = t.length; o < u; o++) t[o]._code = Ct(t[o], e);
            for (r = 0; r < 4; r++) {
                for (l = d[r], n = [], o = 0, s = (u = t.length) - 1; o < u; s = o++)
                    (a = t[o]), (h = t[s]), a._code & l ? h._code & l || (((c = Mt(h, a, l, e, i))._code = Ct(c, e)), n.push(c)) : (h._code & l && (((c = Mt(h, a, l, e, i))._code = Ct(c, e)), n.push(c)), n.push(a));
                t = n;
            }
            return t;
        }
        function Zt(t, e) {
            var i,
                ...
                h = [],
                u = e && e.pointToLayer,
                l = (e && e.coordsToLatLng) || Bt;
            if (!a && !r) return null;
            switch (r.type) {
                case "Point":
                    return (i = l(a)), u ? u(t, i) : new Hi(i);
                case "MultiPoint":
                    for (o = 0, s = a.length; o < s; o++) (i = l(a[o])), h.push(u ? u(t, i) : new Hi(i));
                    return new Ni(h);
                case "LineString":
                case "MultiLineString":
                    return (n = Ot(a, "LineString" === r.type ? 0 : 1, l)), new qi(n, e);
                case "Polygon":
                case "MultiPolygon":
                    return (n = Ot(a, "Polygon" === r.type ? 1 : 2, l)), new Ki(n, e);
                case "GeometryCollection":
                    for (o = 0, s = r.geometries.length; o < s; o++) {
                        var c = Zt({ geometry: r.geometries[o], type: "Feature", properties: t.properties }, e);
                        c && h.push(c);
                    }
                    return new Ni(h);
                default:
        ...
        function Ot(t, e, i) {
            for (var n, o = [], s = 0, r = t.length; s < r; s++) (n = e ? Ot(t[s], e - 1, i) : (i || Bt)(t[s])), o.push(n);
            return o;
        }
        function Rt(t, e) {
        ...
        function Dt(t, e, i, n) {
            for (var o = [], s = 0, r = t.length; s < r; s++) o.push(e ? Dt(t[s], e - 1, i, n) : Rt(t[s], n));
            return !e && i && o.push(o[0]), o;
        }
        function Nt(t, i) {
            return t.feature ? e({}, t.feature, { geometry: i }) : Ft(i);
        }
        function Ft(t) {
        ...
        function Ht(t) {
            return je ? new un(t) : null;
        }
        function Gt(t) {
            return Ue || He ? new pn(t) : null;
        }
        ...
        var Vt =
            ...
            Yt = 0,
            Qt = window.requestAnimationFrame || _("RequestAnimationFrame") || m,
            $t =
        ...
        (v.extend = function (t) {
            ...
            return (
                ...
                t.includes &&
                    ...
                    delete t.includes),
                o.options && (t.options = e(Vt(o.options), t.options)),
                e(o, t),
                (o._initHooks = []),
        ...
        var ee = {
            on: function (t, e, i) {
                ...
                else for (var o = 0, s = (t = u(t)).length; o < s; o++) this._on(t[o], e, i);
                return this;
            },
            off: function (t, e, i) {
                if (t)
                    if ("object" == typeof t) for (var n in t) this._off(n, t[n], e);
                    else for (var o = 0, s = (t = u(t)).length; o < s; o++) this._off(t[o], e, i);
        ...
        (y.prototype = {
            ...
            (w.prototype = {
                ...
                contains: function (t) {
                    var e, i;
                    return (t = "number" == typeof t[0] || t instanceof y ? x(t) : b(t)) instanceof w ? ((e = t.min), (i = t.max)) : (e = i = t), e.x >= this.min.x && i.x <= this.max.x && e.y >= this.min.y && i.y <= this.max.y;
                },
            ...
            (P.prototype = {
                extend: function (t) {
                    ...
                    return (
                        n || o
                            ...
                            : ((this._southWest = new S(e.lat, e.lng)), (this._northEast = new S(i.lat, i.lng))),
                        this
                    );
                },
                pad: function (t) {
                ...
                contains: function (t) {
                    t = "number" == typeof t[0] || t instanceof S || "lat" in t ? M(t) : T(t);
                    var e,
                        i,
                        n = this._southWest,
                        o = this._northEast;
        ...
        var oe = {
                ...
                wrapLatLngBounds: function (t) {
                    ...
                    var s = t.getSouthWest(),
                        r = t.getNorthEast();
                    return new P(new S(s.lat - n, s.lng - o), new S(r.lat - n, r.lng - o));
                },
            },
            se = e({}, oe, {
                wrapLng: [-180, 180],
        ...
        var ae,
            ...
            ce = e({}, le, { code: "EPSG:900913" }),
            de = document.documentElement.style,
            pe = "ActiveXObject" in window,
            _e = pe && !document.addEventListener,
            me = "msLaunchUri" in navigator && !("documentMode" in document),
            fe = k("webkit"),
            ge = k("android"),
            ve = k("android 2") || k("android 3"),
            ye = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
            xe = ge && k("Google") && ye < 537 && !("AudioNode" in window),
            we = !!window.opera,
            be = k("chrome"),
            Pe = k("gecko") && !fe && !we && !pe,
            Le = !be && k("safari"),
            Te = k("phantom"),
            Se = "OTransition" in de,
            Me = 0 === navigator.platform.indexOf("Win"),
            Ce = pe && "transition" in de,
            ze = "WebKitCSSMatrix" in window && "m11" in new window.WebKitCSSMatrix() && !ve,
            Ee = "MozPerspective" in de,
            Ae = !window.L_DISABLE_3D && (Ce || ze || Ee) && !Se && !Te,
            ke = "undefined" != typeof orientation || k("mobile"),
            Ie = ke && fe,
            Ze = ke && ze,
            Be = !window.PointerEvent && window.MSPointerEvent,
            Oe = !(!window.PointerEvent && !Be),
            Re = !window.L_NO_TOUCH && (Oe || "ontouchstart" in window || (window.DocumentTouch && document instanceof window.DocumentTouch)),
            De = ke && we,
            Ne = ke && Pe,
            Fe = (window.devicePixelRatio || window.screen.deviceXDPI / window.screen.logicalXDPI) > 1,
            je = !!document.createElement("canvas").getContext,
            Ue = !(!document.createElementNS || !E("svg").createSVGRect),
            He =
                !Ue &&
                (function () {
                    try {
            ...
            We = Be ? "MSPointerDown" : "pointerdown",
            Ve = Be ? "MSPointerMove" : "pointermove",
            qe = Be ? "MSPointerUp" : "pointerup",
            Ke = Be ? "MSPointerCancel" : "pointercancel",
            Je = ["INPUT", "SELECT", "OPTION"],
            Xe = {},
            Ye = !1,
            Qe = 0,
            $e = Be ? "MSPointerDown" : Oe ? "pointerdown" : "touchstart",
            ti = Be ? "MSPointerUp" : Oe ? "pointerup" : "touchend",
            ei = "_leaflet_",
            ii = tt(["transform", "webkitTransform", "OTransform", "MozTransform", "msTransform"]),
            ni = tt(["webkitTransition", "transition", "OTransition", "MozTransition", "msTransition"]),
        ...
        if ("onselectstart" in document)
            ...
            var si = tt(["userSelect", "WebkitUserSelect", "OUserSelect", "MozUserSelect", "msUserSelect"]);
            (ae = function () {
                if (si) {
                ...
                (he = function () {
                    si && ((document.documentElement.style[si] = ue), (ue = void 0));
                });
        }
        var ri,
            ai,
            ...
            ui = (Object.freeze || Object)({
                ...
                setPosition: it,
                getPosition: nt,
                disableTextSelection: ae,
                enableTextSelection: he,
                disableImageDrag: ot,
                enableImageDrag: st,
                preventOutline: rt,
                restoreOutline: at,
            ...
            li = "_leaflet_events",
            ci = Me && be ? 2 * window.devicePixelRatio : Pe ? window.devicePixelRatio : 1,
            di = {},
            ...
            _i = ie.extend({
                ...
                _runFrame: function (t, e) {
                    ...
                    e && i._round(), it(this._el, i), this.fire("step");
                },
                _complete: function () {
            ...
            mi = ie.extend({
                ...
                initialize: function (t, e) {
                    (e = l(this, e)),
                        ...
                        e.center && void 0 !== e.zoom && this.setView(M(e.center), e.zoom, { reset: !0 }),
                        (this._handlers = []),
                        (this._layers = {}),
                        (this._zoomBoundLayers = {}),
                        (this._sizeChanged = !0),
                        this.callInitHooks(),
                        (this._zoomAnimated = ni && Ae && !De && this.options.zoomAnimation),
                        this._zoomAnimated && (this._createAnimProxy(), lt(this._proxy, oi, this._catchTransitionEnd, this)),
                ...
                setView: function (t, i, n) {
                    return (
                        ...
                        !n.reset &&
                        !0 !== n &&
                        (void 0 !== n.animate && ((n.zoom = e({ animate: n.animate }, n.zoom)), (n.pan = e({ animate: n.animate, duration: n.duration }, n.pan))),
                ...
                panBy: function (t, e) {
                    ...
                    if ((this._panAnim || ((this._panAnim = new _i()), this._panAnim.on({ step: this._onPanTransitionStep, end: this._onPanTransitionEnd }, this)), e.noMoveStart || this.fire("movestart"), !1 !== e.animate)) {
                ...
                flyTo: function (t, e, i) {
                    function n(t) {
                        var e = (d * d - c * c + (t ? -1 : 1) * m * m * p * p) / (2 * (t ? d : c) * m * p),
                            i = Math.sqrt(e * e + 1) - e;
                    ...
                    if (!1 === (i = i || {}).animate || !Ae) return this.setView(t, e, i);
                    this._stop();
                    var a = this.project(this.getCenter()),
                        h = this.project(t),
                        u = this.getSize(),
                        l = this._zoom;
                    (t = M(t)), (e = void 0 === e ? l : e);
                    var c = Math.max(u.x, u.y),
                        d = c * this.getZoomScale(l, e),
                        p = h.distanceTo(a) || 1,
                        _ = 1.42,
                        m = _ * _,
                        g = n(0),
                        v = Date.now(),
                        y = (n(1) - g) / _,
                        x = i.duration ? 1e3 * i.duration : 1e3 * y * 0.8;
                    return (
                        ...
                        function i() {
                            ...
                            n <= 1
                                ? ((this._flyToFrame = f(i, this)),
                                  this._move(
                                      this.unproject(a.add(h.subtract(a).multiplyBy(r(o) / p)), l),
                                      this.getScaleZoom(
                                          c /
                                              (function (t) {
                                                  return c * (s(g) / s(g + _ * t));
                                              })(o),
                                          l
                                      ),
                                      { flyTo: !0 }
                ...
                invalidateSize: function (t) {
                    ...
                    return a.x || a.y
                        ? (t.animate && t.pan
                              ? this.panBy(a)
                              : (t.pan && this._rawPanBy(a), this.fire("move"), t.debounceMoveend ? (clearTimeout(this._sizeTimer), (this._sizeTimer = setTimeout(i(this.fire, this, "moveend"), 200))) : this.fire("moveend")),
                ...
                _handleGeolocationResponse: function (t) {
                    var e = new S(t.coords.latitude, t.coords.longitude),
                ...
                remove: function () {
                    ...
                    for (t in this._panes) G(this._panes[t]);
                    return (this._layers = []), (this._panes = []), delete this._mapPane, delete this._renderer, this;
                },
                createPane: function (t, e) {
                    var i = H("div", "leaflet-pane" + (t ? " leaflet-" + t.replace("Pane", "") + "-pane" : ""), e || this._mapPane);
                ...
                getBoundsZoom: function (t, e, i) {
                    ...
                    var n = this.getZoom() || 0,
                        ...
                        l = Ae ? this.options.zoomSnap : 1,
                        c = h.x / u.x,
                        d = h.y / u.y,
                        p = e ? Math.max(c, d) : Math.min(c, d);
                    return (n = this.getScaleZoom(p, n)), l && ((n = Math.round(n / (l / 100)) * (l / 100)), (n = e ? Math.ceil(n / l) * l : Math.floor(n / l) * l)), Math.max(o, Math.min(s, n));
                },
                getSize: function () {
                ...
                _initContainer: function (t) {
                    ...
                    lt(e, "scroll", this._onScroll, this), (this._containerId = n(e));
                },
                _initLayout: function () {
                    var t = this._container;
                    (this._fadeAnimated = this.options.fadeAnimation && Ae),
                        J(t, "leaflet-container" + (Re ? " leaflet-touch" : "") + (Fe ? " leaflet-retina" : "") + (_e ? " leaflet-oldie" : "") + (Le ? " leaflet-safari" : "") + (this._fadeAnimated ? " leaflet-fade-anim" : ""));
                    var e = U(t, "position");
                ...
                _initPanes: function () {
                    ...
                    (this._paneRenderers = {}),
                        ...
                        this.options.markerZoomAnimation || (J(t.markerPane, "leaflet-zoom-hide"), J(t.shadowPane, "leaflet-zoom-hide"));
                },
                ...
                _initEvents: function (t) {
                    ...
                    e(this._container, "click dblclick mousedown mouseup mouseover mouseout mousemove contextmenu keypress", this._handleDOMEvent, this),
                        ...
                        Ae && this.options.transform3DLimit && (t ? this.off : this.on).call(this, "moveend", this._onMoveEnd);
                },
                _onResize: function () {
                ...
                _handleDOMEvent: function (t) {
                    if (this._loaded && !bt(t)) {
                        var e = t.type;
                        ("mousedown" !== e && "keypress" !== e) || rt(t.target || t.srcElement), this._fireDOMEvent(t, e);
                    }
                },
                ...
                _fireDOMEvent: function (t, i, n) {
                    ...
                    if (!t._stopped && (n = (n || []).concat(this._findEventTargets(t, i))).length) {
                        var s = n[0];
                        "contextmenu" === i && s.listens(i, !0) && gt(t);
                    ...
                    this._panes.mapPane.appendChild(t),
                        this.on(
                            ...
                            function (t) {
                                ...
                                et(this._proxy, this.project(t.center, t.zoom), this.getZoomScale(t.zoom, 1)), i === this._proxy.style[e] && this._animatingZoom && this._onZoomTransitionEnd();
                            },
                            this
                        ),
                        this.on(
                ...
                _animateZoom: function (t, e, n, o) {
                    this._mapPane &&
                        (n && ((this._animatingZoom = !0), (this._animateToCenter = t), (this._animateToZoom = e), J(this._mapPane, "leaflet-zoom-anim")),
                ...
                addTo: function (t) {
                    ...
                    return J(e, "leaflet-control"), -1 !== i.indexOf("bottom") ? n.insertBefore(e, n.firstChild) : n.appendChild(e), this;
                },
                remove: function () {
                    return this._map ? (G(this._container), this.onRemove && this.onRemove(this._map), (this._map = null), this) : this;
                },
        ...
        mi.include({
            ...
            _initControlPos: function () {
                ...
                var e = (this._controlCorners = {}),
                    i = "leaflet-",
                    n = (this._controlContainer = H("div", i + "control-container", this._container));
                t("top", "left"), t("top", "right"), t("bottom", "left"), t("bottom", "right");
            },
            _clearControlPos: function () {
                for (var t in this._controlCorners) G(this._controlCorners[t]);
                G(this._controlContainer), delete this._controlCorners, delete this._controlContainer;
            },
        });
        var vi = fi.extend({
                options: {
                ...
                initialize: function (t, e, i) {
                    for (var n in (l(this, i), (this._layerControlInputs = []), (this._layers = []), (this._lastZIndex = 0), (this._handlingClick = !1), t)) this._addLayer(t[n], n);
                ...
                addTo: function (t) {
                    return fi.prototype.addTo.call(this, t), this._expandIfNotCollapsed();
                },
                onRemove: function () {
                ...
                expand: function () {
                    J(this._container, "leaflet-control-layers-expanded"), (this._form.style.height = null);
                    var t = this._map.getSize().y - (this._container.offsetTop + 50);
                    return t < this._form.clientHeight ? (J(this._form, "leaflet-control-layers-scrollbar"), (this._form.style.height = t + "px")) : X(this._form, "leaflet-control-layers-scrollbar"), this._checkDisabledLayers(), this;
                },
                collapse: function () {
                ...
                _initLayout: function () {
                    ...
                    e.setAttribute("aria-haspopup", !0), ft(e), mt(e);
                    var n = (this._form = H("form", t + "-list"));
                    i && (this._map.on("click", this.collapse, this), ge || lt(e, { mouseenter: this.expand, mouseleave: this.collapse }, this));
                    var o = (this._layersLink = H("a", t + "-toggle", e));
                    (o.href = "#"),
                        (o.title = "Layers"),
                        Re ? (lt(o, "click", vt), lt(o, "click", this.expand, this)) : lt(o, "focus", this.expand, this),
                        i || this.expand(),
                ...
                _update: function () {
                    ...
                    W(this._baseLayersList), W(this._overlaysList), (this._layerControlInputs = []);
                    var t,
                        e,
                        i,
                        n,
                ...
                _addItem: function (t) {
                    ...
                    t.overlay ? (((e = document.createElement("input")).type = "checkbox"), (e.className = "leaflet-control-layers-selector"), (e.defaultChecked = o)) : (e = this._createRadioElement("leaflet-base-layers", o)),
                        ...
                        (e.layerId = n(t.layer)),
                        lt(e, "click", this._onInputClick, this);
            ...
            yi = fi.extend({
                ...
                _createButton: function (t, e, i, n, o) {
                    var s = H("a", i, n);
                    return (s.innerHTML = t), (s.href = "#"), (s.title = e), s.setAttribute("role", "button"), s.setAttribute("aria-label", e), ft(s), lt(s, "click", vt), lt(s, "click", o, this), lt(s, "click", this._refocusOnMap, this), s;
                },
                _updateDisabled: function () {
                    var t = this._map,
                        e = "leaflet-disabled";
                    X(this._zoomInButton, e), X(this._zoomOutButton, e), (this._disabled || t._zoom === t.getMinZoom()) && J(this._zoomOutButton, e), (this._disabled || t._zoom === t.getMaxZoom()) && J(this._zoomInButton, e);
                },
            });
        mi.mergeOptions({ zoomControl: !0 }),
            mi.addInitHook(function () {
        ...
        var xi = fi.extend({
            ...
            wi = fi.extend({
                ...
                onAdd: function (t) {
                    for (var e in ((t.attributionControl = this), (this._container = H("div", "leaflet-control-attribution")), ft(this._container), t._layers))
        ...
        mi.mergeOptions({ attributionControl: !0 }),
            mi.addInitHook(function () {
        ...
        var Pi,
            Li = { Events: ee },
            Ti = Re ? "touchstart mousedown" : "mousedown",
            ...
            Ci = ie.extend({
                ...
                enable: function () {
                    this._enabled || (lt(this._dragStartTarget, Ti, this._onDown, this), (this._enabled = !0));
                },
                disable: function () {
                    this._enabled && (Ci._dragging === this && this.finishDrag(), ct(this._dragStartTarget, Ti, this._onDown, this), (this._enabled = !1), (this._moved = !1));
                },
                _onDown: function (t) {
                    if (
                        !t._simulated &&
                        ...
                        !K(this._element, "leaflet-zoom-anim") &&
                            !(Ci._dragging || t.shiftKey || (1 !== t.which && 1 !== t.button && !t.touches) || ((Ci._dragging = this), this._preventOutline && rt(this._element), ot(), ae(), this._moving)))
                    ) {
                        this.fire("down");
                        var e = t.touches ? t.touches[0] : t,
                            i = ht(this._element);
                        (this._startPoint = new y(e.clientX, e.clientY)), (this._parentScale = ut(i)), lt(document, Mi[t.type], this._onMove, this), lt(document, Si[t.type], this._onUp, this);
                    }
                },
                _onMove: function (t) {
                            ...
                            (i.x || i.y) &&
                                (Math.abs(i.x) + Math.abs(i.y) < this.options.clickTolerance ||
                                    ...
                                    this._moved ||
                                        (this.fire("dragstart"),
                                        (this._moved = !0),
                                        (this._startPos = nt(this._element).subtract(i)),
                                        J(document.body, "leaflet-dragging"),
                                        ...
                                        J(this._lastTarget, "leaflet-drag-target")),
                ...
                finishDrag: function () {
                    for (var t in (X(document.body, "leaflet-dragging"), this._lastTarget && (X(this._lastTarget, "leaflet-drag-target"), (this._lastTarget = null)), Mi))
                        ct(document, Mi[t], this._onMove, this), ct(document, Si[t], this._onUp, this);
                    st(), he(), this._moved && this._moving && (g(this._animRequest), this.fire("dragend", { distance: this._newPos.distanceTo(this._startPos) })), (this._moving = !1), (Ci._dragging = !1);
                },
            }),
            zi = (Object.freeze || Object)({
                ...
                _getBitCode: Ct,
                _sqClosestPointOnSegment: Et,
                isFlat: At,
                _flat: kt,
            }),
            Ei = (Object.freeze || Object)({ clipPolygon: It }),
            Ai = {
                project: function (t) {
            ...
            ki = {
                ...
                unproject: function (t) {
                    for (var e, i = 180 / Math.PI, n = this.R, o = this.R_MINOR / n, s = Math.sqrt(1 - o * o), r = Math.exp(-t.y / n), a = Math.PI / 2 - 2 * Math.atan(r), h = 0, u = 0.1; h < 15 && Math.abs(u) > 1e-7; h++)
                        (e = s * Math.sin(a)), (e = Math.pow((1 - e) / (1 + e), s / 2)), (a += u = Math.PI / 2 - 2 * Math.atan(r * e) - a);
                    return new S(a * i, (t.x * i) / n);
                },
            },
            Ii = (Object.freeze || Object)({ LonLat: Ai, Mercator: ki, SphericalMercator: re }),
            Zi = e({}, se, {
                code: "EPSG:3395",
                projection: ki,
                transformation: (function () {
            ...
            Bi = e({}, se, { code: "EPSG:4326", projection: Ai, transformation: z(0.005555555555555556, 1, -0.005555555555555556, 0.5) }),
            Oi = e({}, oe, {
                projection: Ai,
        ...
        (oe.Earth = se), (oe.EPSG3395 = Zi), (oe.EPSG3857 = le), (oe.EPSG900913 = ce), (oe.EPSG4326 = Bi), (oe.Simple = Oi);
        var Ri = ie.extend({
        ...
        mi.include({
            ...
            _addLayers: function (t) {
                for (var e = 0, i = (t = t ? (Jt(t) ? t : [t]) : []).length; e < i; e++) this.addLayer(t[e]);
            },
        ...
        var Di = Ri.extend({
            ...
            Fi = v.extend({
                ...
                _setIconStyles: function (t, e) {
                    ...
                    var o = x(n),
                        s = x(("shadow" === e && i.shadowAnchor) || i.iconAnchor || (o && o.divideBy(2, !0)));
                ...
                _getIconUrl: function (t) {
                    return (Fe && this.options[t + "RetinaUrl"]) || this.options[t + "Url"];
                },
            }),
            ji = Fi.extend({
                ...
                _getIconUrl: function (t) {
                    return ji.imagePath || (ji.imagePath = this._detectIconPath()), (this.options.imagePath || ji.imagePath) + Fi.prototype._getIconUrl.call(this, t);
                },
            ...
            Ui = bi.extend({
                ...
                addHooks: function () {
                    ...
                    this._draggable || (this._draggable = new Ci(t, t, !0)),
                        ...
                        J(t, "leaflet-marker-draggable");
                },
                removeHooks: function () {
                    this._draggable.off({ dragstart: this._onDragStart, predrag: this._onPreDrag, drag: this._onDrag, dragend: this._onDragEnd }, this).disable(), this._marker._icon && X(this._marker._icon, "leaflet-marker-draggable");
                },
                moved: function () {
                ...
                _adjustPan: function (t) {
                    ...
                    if (!h.contains(s)) {
                        ...
                        i.panBy(u, { animate: !1 }), this._draggable._newPos._add(u), this._draggable._startPos._add(u), it(e._icon, this._draggable._newPos), this._onDrag(t), (this._panRequest = f(this._adjustPan.bind(this, t)));
                    }
                },
                ...
                _onDrag: function (t) {
                    ...
                    i && it(i, n), (e._latlng = o), (t.latlng = o), (t.oldLatLng = this._oldLatLng), e.fire("move", t).fire("drag", t);
                },
            ...
            Hi = Ri.extend({
                ...
                _removeIcon: function () {
                    this.options.riseOnHover && this.off({ mouseover: this._bringToFront, mouseout: this._resetZIndex }), G(this._icon), this.removeInteractiveTarget(this._icon), (this._icon = null);
                },
                ...
                _initInteraction: function () {
                    if (this.options.interactive && (J(this._icon, "leaflet-interactive"), this.addInteractiveTarget(this._icon), Ui)) {
                        var t = this.options.draggable;
                        this.dragging && ((t = this.dragging.enabled()), this.dragging.disable()), (this.dragging = new Ui(this)), t && this.dragging.enable();
                    }
                },
            ...
            Wi = Gi.extend({
                ...
                initialize: function (t, e) {
                    l(this, e), (this._latlng = M(t)), (this._radius = this.options.radius);
                },
                setLatLng: function (t) {
                    return (this._latlng = M(t)), this.redraw(), this.fire("move", { latlng: this._latlng });
                },
                getLatLng: function () {
                    return this._latlng;
                },
            ...
            Vi = Wi.extend({
                initialize: function (t, i, n) {
                    if (("number" == typeof i && (i = e({}, n, { radius: i })), l(this, i), (this._latlng = M(t)), isNaN(this.options.radius))) throw new Error("Circle radius cannot be NaN");
                ...
                setStyle: Gi.prototype.setStyle,
                _project: function () {
                    var t = this._latlng.lng,
                        e = this._latlng.lat,
                        i = this._map,
                        n = i.options.crs;
                    if (n.distance === se.distance) {
                        var o = Math.PI / 180,
                            ...
                            u = i.unproject(h).lat,
                            l = Math.acos((Math.cos(s * o) - Math.sin(e * o) * Math.sin(u * o)) / (Math.cos(e * o) * Math.cos(u * o))) / o;
                        (isNaN(l) || 0 === l) && (l = s / Math.cos((Math.PI / 180) * e)), (this._point = h.subtract(i.getPixelOrigin())), (this._radius = isNaN(l) ? 0 : h.x - i.project([u, t - l]).x), (this._radiusY = h.y - r.y);
                    } else {
            ...
            qi = Gi.extend({
                ...
                closestLayerPoint: function (t) {
                    for (var e, i, n = 1 / 0, o = null, s = Et, r = 0, a = this._parts.length; r < a; r++)
                ...
                getCenter: function () {
                    ...
                    for (t = 0, n = 0; t < h - 1; t++) if (((o = a[t]), (s = a[t + 1]), (n += i = o.distanceTo(s)) > e)) return (r = (n - e) / i), this._map.layerPointToLatLng([s.x - r * (s.x - o.x), s.y - r * (s.y - o.y)]);
                },
                getBounds: function () {
                    return this._bounds;
                },
                ...
                _defaultShape: function () {
                    return At(this._latlngs) ? this._latlngs : this._latlngs[0];
                },
                _convertLatLngs: function (t) {
                    for (var e = [], i = At(t), n = 0, o = t.length; n < o; n++) i ? ((e[n] = M(t[n])), this._bounds.extend(e[n])) : (e[n] = this._convertLatLngs(t[n]));
                    return e;
                },
                _project: function () {
                    var t = new w();
                    ...
                    if (((this._parts = []), this._pxBounds && this._pxBounds.intersects(t)))
                        if (this.options.noClip) this._parts = this._rings;
                            ...
                            for (e = 0, n = 0, o = this._rings.length; e < o; e++)
                                for (i = 0, s = (a = this._rings[e]).length; i < s - 1; i++) (r = St(a[i], a[i + 1], t, i, !0)) && ((h[n] = h[n] || []), h[n].push(r[0]), (r[1] === a[i + 1] && i !== s - 2) || (h[n].push(r[1]), n++));
                        }
                },
                ...
                _containsPoint: function (t, e) {
                    ...
                    for (i = 0, s = this._parts.length; i < s; i++) for (n = 0, o = (r = (a = this._parts[i]).length) - 1; n < r; o = n++) if ((e || 0 !== n) && Tt(t, a[o], a[n]) <= h) return !0;
                    return !1;
                },
            });
        qi._flat = kt;
        var Ki = qi.extend({
                ...
                getCenter: function () {
                    ...
                    var t,
                        ...
                        l = u.length;
                    if (!l) return null;
                    for (s = r = a = 0, t = 0, e = l - 1; t < l; e = t++) (i = u[t]), (n = u[e]), (o = i.y * n.x - n.y * i.x), (r += (i.x + n.x) * o), (a += (i.y + n.y) * o), (s += 3 * o);
                    return (h = 0 === s ? u[0] : [r / s, a / s]), this._map.layerPointToLatLng(h);
                },
                _convertLatLngs: function (t) {
                    var e = qi.prototype._convertLatLngs.call(this, t),
                        i = e.length;
                    return i >= 2 && e[0] instanceof S && e[0].equals(e[i - 1]) && e.pop(), e;
                },
                _setLatLngs: function (t) {
                    qi.prototype._setLatLngs.call(this, t), At(this._latlngs) && (this._latlngs = [this._latlngs]);
                },
                _defaultShape: function () {
                ...
                _clipPoints: function () {
                    ...
                    if (((t = new w(t.min.subtract(i), t.max.add(i))), (this._parts = []), this._pxBounds && this._pxBounds.intersects(t)))
                        if (this.options.noClip) this._parts = this._rings;
                        else for (var n, o = 0, s = this._rings.length; o < s; o++) (n = It(this._rings[o], t, !0)).length && this._parts.push(n);
                },
                _updatePath: function () {
                ...
                _containsPoint: function (t) {
                    ...
                    for (o = 0, a = this._parts.length; o < a; o++)
                        for (s = 0, r = (h = (e = this._parts[o]).length) - 1; s < h; r = s++) (i = e[s]), (n = e[r]), i.y > t.y != n.y > t.y && t.x < ((n.x - i.x) * (t.y - i.y)) / (n.y - i.y) + i.x && (u = !u);
                    return u || qi.prototype._containsPoint.call(this, t, !0);
                },
            }),
            Ji = Ni.extend({
                initialize: function (t, e) {
                ...
                addData: function (t) {
                    ...
                    var r = Zt(t, s);
                    return r ? ((r.feature = Ft(t)), (r.defaultOptions = r.options), this.resetStyle(r), s.onEachFeature && s.onEachFeature(t, r), this.addLayer(r)) : this;
                },
            ...
            Xi = {
                toGeoJSON: function (t) {
                    return Nt(this, { type: "Point", coordinates: Rt(this.getLatLng(), t) });
                },
            };
        Hi.include(Xi),
            Vi.include(Xi),
            ...
            qi.include({
                toGeoJSON: function (t) {
                    var e = !At(this._latlngs);
                    return Nt(this, { type: (e ? "Multi" : "") + "LineString", coordinates: Dt(this._latlngs, e ? 1 : 0, !1, t) });
                },
            }),
            Ki.include({
                toGeoJSON: function (t) {
                    var e = !At(this._latlngs),
                        i = e && !At(this._latlngs[0]),
                        n = Dt(this._latlngs, i ? 2 : e ? 1 : 0, !0, t);
                    return e || (n = [n]), Nt(this, { type: (i ? "Multi" : "") + "Polygon", coordinates: n });
                },
            }),
            Di.include({
                ...
                toGeoJSON: function (t) {
                    ...
                    return (
                        ...
                        i ? Nt(this, { geometries: n, type: "GeometryCollection" }) : { type: "FeatureCollection", features: n }
                    );
                },
            });
        var Yi = jt,
            Qi = Ri.extend({
                ...
                initialize: function (t, e, i) {
                    (this._url = t), (this._bounds = T(e)), l(this, i);
                },
                onAdd: function () {
                    this._image || (this._initImage(), this.options.opacity < 1 && this._updateOpacity()),
                        this.options.interactive && (J(this._image, "leaflet-interactive"), this.addInteractiveTarget(this._image)),
                        this.getPane().appendChild(this._image),
                        this._reset();
                },
                onRemove: function () {
                    G(this._image), this.options.interactive && this.removeInteractiveTarget(this._image);
                },
                setOpacity: function (t) {
                ...
                _initImage: function () {
                    ...
                    J(e, "leaflet-image-layer"),
                        this._zoomAnimated && J(e, "leaflet-zoom-animated"),
                        this.options.className && J(e, this.options.className),
                        (e.onselectstart = r),
                        (e.onmousemove = r),
                ...
                _reset: function () {
                    var t = this._image,
                        ...
                        i = e.getSize();
                    it(t, e.min), (t.style.width = i.x + "px"), (t.style.height = i.y + "px");
                },
                _updateOpacity: function () {
            ...
            $i = Qi.extend({
                ...
                _initImage: function () {
                    ...
                    if ((J(e, "leaflet-image-layer"), this._zoomAnimated && J(e, "leaflet-zoom-animated"), (e.onselectstart = r), (e.onmousemove = r), (e.onloadeddata = i(this.fire, this, "load")), t)) {
                        for (var n = e.getElementsByTagName("source"), o = [], s = 0; s < n.length; s++) o.push(n[s].src);
                        this._url = n.length > 0 ? o : [e.src];
                    } else {
                        Jt(this._url) || (this._url = [this._url]), (e.autoplay = !!this.options.autoplay), (e.loop = !!this.options.loop);
            ...
            tn = Ri.extend({
                ...
                onRemove: function (t) {
                    t._fadeAnimated ? ($(this._container, 0), (this._removeTimeout = setTimeout(i(G, void 0, this._container), 200))) : G(this._container);
                },
                getLatLng: function () {
                    return this._latlng;
                },
                ...
                _updatePosition: function () {
                    if (this._map) {
                        var t = this._map.latLngToLayerPoint(this._latlng),
                            ...
                            i = this._getAnchor();
                        this._zoomAnimated ? it(this._container, t.add(i)) : (e = e.add(t).add(i));
            ...
            en = tn.extend({
                ...
                onAdd: function (t) {
                    tn.prototype.onAdd.call(this, t), t.fire("popupopen", { popup: this }), this._source && (this._source.fire("popupopen", { popup: this }, !0), this._source instanceof Gi || this._source.on("preclick", _t));
                },
                onRemove: function (t) {
                    tn.prototype.onRemove.call(this, t), t.fire("popupclose", { popup: this }), this._source && (this._source.fire("popupclose", { popup: this }, !0), this._source instanceof Gi || this._source.off("preclick", _t));
                },
                getEvents: function () {
                ...
                _initLayout: function () {
                    ...
                    if (
                        ((this._contentNode = H("div", t + "-content", i)),
                        ft(i),
                        mt(this._contentNode),
                        lt(i, "contextmenu", _t),
                        (this._tipContainer = H("div", t + "-tip-container", e)),
                        (this._tip = H("div", t + "-tip", this._tipContainer)),
                        this.options.closeButton)
                    ) {
                        var n = (this._closeButton = H("a", t + "-close-button", e));
                ...
                _updateLayout: function () {
                    ...
                    o && n > o ? ((e.height = o + "px"), J(t, "leaflet-popup-scrolled")) : X(t, "leaflet-popup-scrolled"), (this._containerWidth = this._container.offsetWidth);
                },
                _animateZoom: function (t) {
                    var e = this._map._latLngToNewLayerPoint(this._latlng, t.zoom, t.center),
                        i = this._getAnchor();
                    it(this._container, e.add(i));
                },
                _adjustPan: function () {
        ...
        mi.mergeOptions({ closePopupOnClick: !0 }),
            mi.include({
                openPopup: function (t, e, i) {
                    return t instanceof en || (t = new en(i).setContent(t)), e && t.setLatLng(e), this.hasLayer(t) ? this : (this._popup && this._popup.options.autoClose && this.closePopup(), (this._popup = t), this.addLayer(t));
                },
            ...
            Ri.include({
                bindPopup: function (t, e) {
                    return (
                        t instanceof en ? (l(t, e), (this._popup = t), (t._source = this)) : ((this._popup && !e) || (this._popup = new en(e, this)), this._popup.setContent(t)),
                ...
                openPopup: function (t, e) {
                    if ((t instanceof Ri || ((e = t), (t = this)), t instanceof Ni))
                ...
                _openPopup: function (t) {
                    ...
                    this._popup && this._map && (vt(t), e instanceof Gi ? this.openPopup(t.layer || t.target, t.latlng) : this._map.hasLayer(this._popup) && this._popup._source === e ? this.closePopup() : this.openPopup(e, t.latlng));
                },
        ...
        var nn = tn.extend({
            ...
            onAdd: function (t) {
                tn.prototype.onAdd.call(this, t), this.setOpacity(this.options.opacity), t.fire("tooltipopen", { tooltip: this }), this._source && this._source.fire("tooltipopen", { tooltip: this }, !0);
            },
            onRemove: function (t) {
                tn.prototype.onRemove.call(this, t), t.fire("tooltipclose", { tooltip: this }), this._source && this._source.fire("tooltipclose", { tooltip: this }, !0);
            },
            getEvents: function () {
                var t = tn.prototype.getEvents.call(this);
                return Re && !this.options.permanent && (t.preclick = this._close), t;
            },
            _close: function () {
            ...
            _setPosition: function (t) {
                ...
                "top" === s
                    ...
                    : ((s = "left"), (t = t.subtract(x(r + u.x - h.x, a / 2 - u.y - h.y, !0)))),
                    X(i, "leaflet-tooltip-right"),
                    X(i, "leaflet-tooltip-left"),
                    X(i, "leaflet-tooltip-top"),
                    X(i, "leaflet-tooltip-bottom"),
                    J(i, "leaflet-tooltip-" + s),
                    it(i, t);
            },
            _updatePosition: function () {
                var t = this._map.latLngToLayerPoint(this._latlng);
        ...
        mi.include({
            openTooltip: function (t, e, i) {
                return t instanceof nn || (t = new nn(i).setContent(t)), e && t.setLatLng(e), this.hasLayer(t) ? this : this.addLayer(t);
            },
            ...
            Ri.include({
                bindTooltip: function (t, e) {
                    return (
                        t instanceof nn ? (l(t, e), (this._tooltip = t), (t._source = this)) : ((this._tooltip && !e) || (this._tooltip = new nn(e, this)), this._tooltip.setContent(t)),
                ...
                _initTooltipInteractions: function (t) {
                    if (t || !this._tooltipHandlersAdded) {
                        ...
                        this._tooltip.options.permanent
                            ...
                            : ((i.mouseover = this._openTooltip), (i.mouseout = this.closeTooltip), this._tooltip.options.sticky && (i.mousemove = this._moveTooltip), Re && (i.click = this._openTooltip)),
                            this[e](i),
                ...
                openTooltip: function (t, e) {
                    ...
                    return (
                        ...
                        this._tooltip &&
                            ...
                            this._tooltip.options.interactive && this._tooltip._container && (J(this._tooltip._container, "leaflet-clickable"), this.addInteractiveTarget(this._tooltip._container))),
                        this
                    );
                },
                closeTooltip: function () {
                    return (
                        this._tooltip && (this._tooltip._close(), this._tooltip.options.interactive && this._tooltip._container && (X(this._tooltip._container, "leaflet-clickable"), this.removeInteractiveTarget(this._tooltip._container))),
                        this
                    );
                },
        ...
        var sn = Ri.extend({
                ...
                onRemove: function (t) {
                    this._removeAllTiles(), G(this._container), t._removeZoomLimit(this), (this._container = null), (this._tileZoom = void 0);
                },
                bringToFront: function () {
                    ...
                    if (void 0 !== t) {
                        for (var i in this._levels)
                            this._levels[i].el.children.length || i === t
                                ...
                                : (G(this._levels[i].el), this._removeTilesAtZoom(i), this._onRemoveLevel(i), delete this._levels[i]);
                        var n = this._levels[t],
                            o = this._map;
                        return (
                            n ||
                                (((n = this._levels[t] = {}).el = H("div", "leaflet-tile-container leaflet-zoom-animated", this._container)),
                                (n.el.style.zIndex = e),
                ...
                _invalidateAll: function () {
                    for (var t in this._levels) G(this._levels[t].el), this._onRemoveLevel(t), delete this._levels[t];
                ...
                _removeTile: function (t) {
                    var e = this._tiles[t];
                    e && (G(e.el), delete this._tiles[t], this.fire("tileunload", { tile: e.el, coords: this._keyToTileCoords(t) }));
                },
                _initTile: function (t) {
                    ...
                    (t.style.width = e.x + "px"),
                        ...
                        (t.onselectstart = r),
                        (t.onmousemove = r),
                        _e && this.options.opacity < 1 && $(t, this.options.opacity),
                ...
                _tileReady: function (t, e, n) {
                    ...
                    (n = this._tiles[o]) &&
                        ((n.loaded = +new Date()),
                        this._map._fadeAnimated ? ($(n.el, 0), g(this._fadeFrame), (this._fadeFrame = f(this._updateOpacity, this))) : ((n.active = !0), this._pruneTiles()),
                        e || (J(n.el, "leaflet-tile-loaded"), this.fire("tileload", { tile: n.el, coords: t })),
                        this._noTilesToLoad() && ((this._loading = !1), this.fire("load"), _e || !this._map._fadeAnimated ? f(this._pruneTiles, this) : setTimeout(i(this._pruneTiles, this), 250)));
                },
            ...
            rn = sn.extend({
                ...
                createTile: function (t, e) {
                    ...
                    return (
                        lt(n, "load", i(this._tileOnLoad, this, e, n)),
                        lt(n, "error", i(this._tileOnError, this, e, n)),
                ...
                getTileUrl: function (t) {
                    var i = { r: Fe ? "@2x" : "", s: this._getSubdomain(t), x: t.x, y: t.y, z: this._getZoomForUrl() };
                ...
                _tileOnLoad: function (t, e) {
                    _e ? setTimeout(i(t, this, null, e), 0) : t(null, e);
                },
                ...
                _abortLoading: function () {
                    var t, e;
                    for (t in this._tiles) this._tiles[t].coords.z !== this._tileZoom && (((e = this._tiles[t].el).onload = r), (e.onerror = r), e.complete || ((e.src = Xt), G(e), delete this._tiles[t]));
                },
                _removeTile: function (t) {
                    var e = this._tiles[t];
                    if (e) return xe || e.el.setAttribute("src", Xt), sn.prototype._removeTile.call(this, t);
                },
                _tileReady: function (t, e, i) {
                    if (this._map && (!i || i.getAttribute("src") !== Xt)) return sn.prototype._tileReady.call(this, t, e, i);
                },
            }),
            an = rn.extend({
                ...
                initialize: function (t, i) {
                    ...
                    var s = (i = l(this, i)).detectRetina && Fe ? 2 : 1,
                        r = this.getTileSize();
        ...
        var hn = Ri.extend({
                ...
                onAdd: function () {
                    this._container || (this._initContainer(), this._zoomAnimated && J(this._container, "leaflet-zoom-animated")), this.getPane().appendChild(this._container), this._update(), this.on("update", this._updatePaths, this);
                },
                onRemove: function () {
                ...
                _updateTransform: function (t, e) {
                    ...
                    Ae ? et(this._container, a, i) : it(this._container, a);
                },
                _reset: function () {
            ...
            un = hn.extend({
                ...
                _destroyContainer: function () {
                    g(this._redrawRequest), delete this._ctx, G(this._container), ct(this._container), delete this._container;
                },
                _updatePaths: function () {
                ...
                _update: function () {
                    if (!this._map._animatingZoom || !this._bounds) {
                        ...
                        var t = this._bounds,
                            ...
                            i = t.getSize(),
                            n = Fe ? 2 : 1;
                        it(e, t.min), (e.width = n * i.x), (e.height = n * i.y), (e.style.width = i.x + "px"), (e.style.height = i.y + "px"), Fe && this._ctx.scale(2, 2), this._ctx.translate(-t.min.x, -t.min.y), this.fire("update");
                    }
                },
                _reset: function () {
                ...
                _removePath: function (t) {
                    var e = t._order,
                        i = e.next,
                        o = e.prev;
                    i ? (i.prev = o) : (this._drawLast = o), o ? (o.next = i) : (this._drawFirst = i), delete this._drawnLayers[t._leaflet_id], delete t._order, delete this._layers[n(t)], this._requestRedraw(t);
                },
                ...
                _handleMouseHover: function (t, e) {
                    ...
                    n !== this._hoveredLayer && (this._handleMouseOut(t), n && (J(this._container, "leaflet-interactive"), this._fireEvent([n], t, "mouseover"), (this._hoveredLayer = n))),
            ...
            cn = {
                ...
                _initPath: function (t) {
                    ...
                    J(e, "leaflet-vml-shape " + (this.options.className || "")), (e.coordsize = "1 1"), (t._path = ln("path")), e.appendChild(t._path), this._updateStyle(t), (this._layers[n(t)] = t);
                },
                _addPath: function (t) {
                    var e = t._container;
                ...
                _removePath: function (t) {
                    var e = t._container;
                    G(e), t.removeInteractiveTarget(e), delete this._layers[n(t)];
                },
                _updateStyle: function (t) {
                    var e = t._stroke,
                        i = t._fill,
                    ...
                    (o.stroked = !!n.stroke),
                        (o.filled = !!n.fill),
                        n.stroke
                            ? (e || (e = t._stroke = ln("stroke")),
                              o.appendChild(e),
                              (e.weight = n.weight + "px"),
                              (e.color = n.color),
                              (e.opacity = n.opacity),
                              n.dashArray ? (e.dashStyle = Jt(n.dashArray) ? n.dashArray.join(" ") : n.dashArray.replace(/( *, *)/g, " ")) : (e.dashStyle = ""),
                              (e.endcap = n.lineCap.replace("butt", "flat")),
                              (e.joinstyle = n.lineJoin))
                            : e && (o.removeChild(e), (t._stroke = null)),
                        n.fill ? (i || (i = t._fill = ln("fill")), o.appendChild(i), (i.color = n.fillColor || n.color), (i.opacity = n.fillOpacity)) : i && (o.removeChild(i), (t._fill = null));
                },
                _updateCircle: function (t) {
            ...
            pn = hn.extend({
                ...
                _destroyContainer: function () {
                    G(this._container), ct(this._container), delete this._container, delete this._rootGroup, delete this._svgSize;
                },
                ...
                _initPath: function (t) {
                    ...
                    t.options.className && J(e, t.options.className), t.options.interactive && J(e, "leaflet-interactive"), this._updateStyle(t), (this._layers[n(t)] = t);
                },
                _addPath: function (t) {
                    this._rootGroup || this._initContainer(), this._rootGroup.appendChild(t._path), t.addInteractiveTarget(t._path);
                },
                _removePath: function (t) {
                    G(t._path), t.removeInteractiveTarget(t._path), delete this._layers[n(t)];
                },
                _updatePath: function (t) {
        ...
        He && pn.include(cn),
            mi.include({
                ...
                _createRenderer: function (t) {
                    return (this.options.preferCanvas && Ht(t)) || Gt(t);
                },
            });
        var _n = Ki.extend({
            initialize: function (t, e) {
        ...
        (pn.create = dn),
            (pn.pointsToPath = A),
            (Ji.geometryToLayer = Zt),
            (Ji.coordsToLatLng = Bt),
            (Ji.coordsToLatLngs = Ot),
            (Ji.latLngToCoords = Rt),
            (Ji.latLngsToCoords = Dt),
            (Ji.getFeature = Nt),
            (Ji.asFeature = Ft),
            mi.mergeOptions({ boxZoom: !0 });
        var mn = bi.extend({
            initialize: function (t) {
            ...
            _onMouseDown: function (t) {
                ...
                this._clearDeferredResetState(),
                    ...
                    lt(document, { contextmenu: vt, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown }, this);
            },
            _onMouseMove: function (t) {
                this._moved || ((this._moved = !0), (this._box = H("div", "leaflet-zoom-box", this._container)), J(this._container, "leaflet-crosshair"), this._map.fire("boxzoomstart")),
                    (this._point = this._map.mouseEventToContainerPoint(t));
                var e = new w(this._point, this._startPoint),
                    i = e.getSize();
                it(this._box, e.min), (this._box.style.width = i.x + "px"), (this._box.style.height = i.y + "px");
            },
            _finish: function () {
                this._moved && (G(this._box), X(this._container, "leaflet-crosshair")), he(), st(), ct(document, { contextmenu: vt, mousemove: this._onMouseMove, mouseup: this._onMouseUp, keydown: this._onKeyDown }, this);
            },
        ...
        mi.addInitHook("addHandler", "boxZoom", mn), mi.mergeOptions({ doubleClickZoom: !0 });
        var fn = bi.extend({
            addHooks: function () {
        ...
        mi.addInitHook("addHandler", "doubleClickZoom", fn), mi.mergeOptions({ dragging: !0, inertia: !ve, inertiaDeceleration: 3400, inertiaMaxSpeed: 1 / 0, easeLinearity: 0.2, worldCopyJump: !1, maxBoundsViscosity: 0 });
        var gn = bi.extend({
            addHooks: function () {
                if (!this._draggable) {
                    var t = this._map;
                    (this._draggable = new Ci(t._mapPane, t._container)),
        ...
        mi.addInitHook("addHandler", "dragging", gn), mi.mergeOptions({ keyboard: !0, keyboardPanDelta: 80 });
        var vn = bi.extend({
            ...
            addHooks: function () {
                ...
                t.tabIndex <= 0 && (t.tabIndex = "0"), lt(t, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this), this._map.on({ focus: this._addHooks, blur: this._removeHooks }, this);
            },
            removeHooks: function () {
                this._removeHooks(), ct(this._map._container, { focus: this._onFocus, blur: this._onBlur, mousedown: this._onMouseDown }, this), this._map.off({ focus: this._addHooks, blur: this._removeHooks }, this);
            },
        ...
        mi.addInitHook("addHandler", "keyboard", vn), mi.mergeOptions({ scrollWheelZoom: !0, wheelDebounceTime: 40, wheelPxPerZoomLevel: 60 });
        var yn = bi.extend({
            addHooks: function () {
            ...
            _onWheelScroll: function (t) {
                ...
                clearTimeout(this._timer), (this._timer = setTimeout(i(this._performZoom, this), o)), vt(t);
            },
        ...
        mi.addInitHook("addHandler", "scrollWheelZoom", yn), mi.mergeOptions({ tap: !0, tapTolerance: 15 });
        var xn = bi.extend({
            addHooks: function () {
            ...
            _onDown: function (t) {
                if (t.touches) {
                    ...
                    (this._startPos = this._newPos = new y(e.clientX, e.clientY)),
                        n.tagName && "a" === n.tagName.toLowerCase() && J(n, "leaflet-active"),
            ...
            _onUp: function (t) {
                if ((clearTimeout(this._holdTimeout), ct(document, { touchmove: this._onMove, touchend: this._onUp }, this), this._fireClick && t && t.changedTouches)) {
                    var e = t.changedTouches[0],
                        i = e.target;
                    i && i.tagName && "a" === i.tagName.toLowerCase() && X(i, "leaflet-active"), this._simulateEvent("mouseup", e), this._isTapValid() && this._simulateEvent("click", e);
                }
            },
        ...
        Re && !Oe && mi.addInitHook("addHandler", "tap", xn), mi.mergeOptions({ touchZoom: Re && !ve, bounceAtZoomLimits: !0 });
        var wn = bi.extend({
            addHooks: function () {
                J(this._map._container, "leaflet-touch-zoom"), lt(this._map._container, "touchstart", this._onTouchStart, this);
            },
            removeHooks: function () {
        ...
        mi.addInitHook("addHandler", "touchZoom", wn),
            (mi.BoxZoom = mn),
            (mi.DoubleClickZoom = fn),
            (mi.Drag = gn),
            (mi.Keyboard = vn),
            (mi.ScrollWheelZoom = yn),
            (mi.Tap = xn),
            (mi.TouchZoom = wn),
            (Object.freeze = Wt),
    ...
    (function (t) {
        ...
        var e = { exif: !0 },
            ...
            n = function (i) {
                return (this.core = t(i).data("lightGallery")), (this.$el = t(i)), (this.core.s = t.extend({}, e, this.core.s)), (this.exif = {}), (this.html = ""), (this.fadeDuration = 250), this.init(), this;
            };
        (n.prototype.appendData = function (t, e, i, n) {
            var o = this.exif[t];
            if (o) {
                (e = (e || t) + ": "), (i = i || ""), (n = n || "");
                var s = "";
                "string" == typeof o && o.startsWith(i) && (i = ""),
                    "string" == typeof o && o.endsWith(n) && (n = ""),
                    "ExposureTime" === t && o < 1
                        ? (o = "1/" + Math.round(1 / parseFloat(o)))
                        : "DateTimeOriginal" === t
                        ? (o = this.parseDate(o).toLocaleString())
                        : "GPSLatitude" === t && this.exif.Geo
                        ? ((o = Number.parseFloat(Math.abs(this.exif.Geo[0]).toFixed(5))), this.exif.GPSLatitudeRef && (n = " " + this.exif.GPSLatitudeRef.replace("North", "N").replace("South", "S")))
                        : "GPSLongitude" === t && this.exif.Geo
                        ? ((o = Number.parseFloat(Math.abs(this.exif.Geo[1]).toFixed(5))), this.exif.GPSLongitudeRef && (n = " " + this.exif.GPSLongitudeRef.replace("East", "E").replace("West", "W")))
                        : isNaN(o) || (o = +parseFloat(o).toFixed(2)),
                    ("Make" === t || "Model" === t) && ((o = o.toLowerCase()), (s = 'style="text-transform: capitalize;"')),
                    (this.html += "<li " + s + ">" + e + i + o + n + "</li>");
            }
        }),
            (n.prototype.renderExif = function () {
                (this.html = this.exifHtml), t(".lg-exif .content").html(this.html), this.exif.Geo && (t("#map").fadeIn(this.fadeDuration), this.map.setView(this.exif.Geo, 15), this.marker.setLatLng(this.exif.Geo));
            }),
            ...
            (n.prototype.init = function () {
                this.core.$outer.prepend('<div class="lg-exif hidden"><div><h3>Image Information</h3>            <span class="lg-hide lg-icon"></span></div><hr><div class="content"></div>            <div id="map"</div></div>'),
                    (this.element = this.core.$outer.find(".lg-exif"));
                let e = this;
                this.$el.on("onAfterSlide.lg", function () {
                    e.update(), t(".lg-exif .content").fadeIn(e.fadeDuration);
                }),
                    this.$el.on("onBeforeSlide.lg", function () {
                        t(".lg-exif .content").fadeOut(e.fadeDuration),
                            t("#map").fadeOut(e.fadeDuration, () => {
                                e.map.setZoom(15);
                            });
                    }),
                    this.core.$outer.find(".lg-toolbar .lg-close").after('<span class="lg-icon lg-info"></span>'),
                    this.core.$outer.find(".lg-toolbar .lg-info, .lg-exif .lg-hide").on("click", function () {
                        e.element.toggleClass("hidden");
                    }),
                    (this.marker = L.marker([0, 0], { icon: i })),
                    (this.map = L.map("map", {
                        zoom: 15,
                        layers: [L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png", { attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors' }), this.marker],
                    })),
                    t("#map").hide(),
                    this.update();
            }),
            ...
            (n.prototype.getGeo = function () {
                return this.exif.GPSLatitude && this.exif.GPSLongitude
                    ? [
                          this.parseDMS(this.exif.GPSLatitude) * ("S" === this.exif.GPSLatitudeRef || "South" === this.exif.GPSLatitudeRef ? -1 : 1),
                          this.parseDMS(this.exif.GPSLongitude) * ("W" === this.exif.GPSLongitudeRef || "West" === this.exif.GPSLongitudeRef ? -1 : 1),
                      ]
                    : null;
            }),
            (n.prototype.parseDMS = function (t) {
                return 3 === t.length ? t[0] + t[1] / 60 + t[2] / 3600 : t;
            }),
            (n.prototype.destroy = function () {
                this.element.remove();
            }),
            (t.fn.lightGallery.modules.exif = n);
